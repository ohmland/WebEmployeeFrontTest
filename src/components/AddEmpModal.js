              ...
              <Form onSubmit={this.handleSubmit}>
                ...
                <Form.Group controlId="EmployeeFirstname">
                  ...
                  <Form.Control type="text" name="EmployeeFirstname"
                    required placeholder="Employee Firstname"
                  />
                </Form.Group>
                ...
                <Form.Group controlId="EmployeeLastname">
                  ...
                  <Form.Control type="text" name="EmployeeLastname"
                    required placeholder="Employee Lastname"
                  />
                </Form.Group>
                ...
                <Form.Group controlId="EmployeePhone">
                  ...
                  <Form.Control type="text" name="EmployeePhone"
                    required placeholder="Employee Phone"
                  />
                </Form.Group>
                ...
                <Form.Group controlId="EmployeeMail">
                  ...
                  <Form.Control type="text" name="EmployeeMail"
                    required placeholder="Employee Mail"
                  />
                </Form.Group>
